...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from SwitchCase.y  */
...
const int YY_parse_CLASS::SWITCH=260;
const int YY_parse_CLASS::CASE=261;
...
const int YY_parse_CLASS::DEFAULT=266;
const int YY_parse_CLASS::LPAR=267;
const int YY_parse_CLASS::RPAR=268;
const int YY_parse_CLASS::LBR=269;
const int YY_parse_CLASS::RBR=270;
...
static const short yyprhs[] = {     0,
     0,     2,     8,    12,    18,    22,    23,    29,    33,    37,
    39,    42,    43,    46,    49,    52,    55
};

static const short yyrhs[] = {    17,
     0,     5,    12,     3,    13,    18,     0,    14,    19,    15,
     0,     6,     3,    10,    20,    19,     0,    11,    10,    20,
     0,     0,    14,    21,     7,     9,    15,     0,    14,    21,
    15,     0,    22,     7,     9,     0,    22,     0,    22,    21,
     0,     0,     4,    22,     0,     3,    22,     0,    12,    22,
     0,    13,    22,     0,     9,     0
};
...
static const short yyrline[] = { 0,
    12,    14,    17,    20,    20,    20,    23,    23,    23,    23,
    26,    26,    29,    29,    29,    29,    29
};

static const char * const yytname[] = {   "$","error","$illegal.","VAR","CHAR",
"SWITCH","CASE","BREAK","TYPE","SEMICOLON","COLON","DEFAULT","LPAR","RPAR","LBR",
"RBR","S","START","DEF","BODY","OUTBLOCK","INBLOCK","ST",""
};
#endif
...
static const short yydefact[] = {     0,
     0,     1,     0,     0,     0,     6,     2,     0,     0,     0,
     0,     0,     3,     0,     0,     0,    17,     0,     0,    12,
     5,    10,     6,    14,    13,    15,    16,     0,    12,     0,
     4,     0,     8,    11,     9,     0,     7,     0,     0,     0
};
...
static const short yypact[] = {     4,
    -1,-32768,    17,     8,     9,     2,-32768,    19,    16,    10,
    20,     3,-32768,     3,    15,    15,-32768,    15,    15,    15,
-32768,    22,     2,-32768,-32768,-32768,-32768,    -5,    15,    23,
-32768,    24,-32768,-32768,-32768,    21,-32768,    31,    34,-32768
};

static const short yypgoto[] = {-32768,
-32768,-32768,    12,    25,    11,   -15
};
...
static const short yytable[] = {    24,
    25,    32,    26,    27,    29,    15,    16,     8,     1,    33,
     3,    17,     9,    29,    18,    19,    20,    15,    16,     4,
     5,    11,     6,    17,    13,    12,    18,    19,    30,    14,
    39,    35,    36,    40,    31,    37,     0,     0,    23,    34
};

static const short yycheck[] = {    15,
    16,     7,    18,    19,    20,     3,     4,     6,     5,    15,
    12,     9,    11,    29,    12,    13,    14,     3,     4,     3,
    13,     3,    14,     9,    15,    10,    12,    13,     7,    10,
     0,     9,     9,     0,    23,    15,    -1,    -1,    14,    29
};
...
case 1:
#line 12 "SwitchCase.y"
{printf("Valid Switch-Case Syntax. Input accepted!"); exit(0);;
    break;}
}
